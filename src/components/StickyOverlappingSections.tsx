...
const texts = {
  setOne: {
    ...
    titleTexts: [
      'Great ',
      'investment',
      ' opportunities decorrelated from capital markets.',
    ],
  },
  setTwo: {
    highlightIndex: 1,
    titleTexts: [
      'Fully regulated specialist ',
      'insurance',
      ' companies underwrite, price the risk and take a lead investment line.',
    ],
  ...
  setThree: {
    ...
    titleTexts: [
      'Investors',
      ' can build diversified investment portfolios to increase capital efficiency and generate leverage as insurance companies do.',
    ],
  },
}
...
export const StickyOverlappingSections = ({
  ...
  const moveInAnimationValue = isMaxHeight750
    ? 700
    : isMaxHeight800
    ? 630
    : isMaxHeight850
      ...
      {!isTablet && !isMaxHeight700 ? (
        <ScrollPage>
          <Animator
            ...
            style={{ width: '80vw', transformOrigin: '0% 0%' }}
          >
            <StickySection>
              <ImageWrapper>
                {isLaptop && (
                ...
                {isPhone && (
                  <img src={phone} style={{ width: '100%' }} alt="phone" />
                )}
                {isScreen && (
                  <img src={screen} style={{ width: '100%' }} alt="screen" />
                )}
              </ImageWrapper>
        ...
        <StickySection>
          {isLaptop && (
            <img src={laptop} style={{ width: '60%' }} alt="laptop" />
          )}
          {isPhone && (
            <img
              src={phone}
          ...
          {isScreen && (
            <img src={screen} style={{ width: '50%' }} alt="screen" />
          )}
          {isLaptop && <TextSticky textData={texts.setOne} />}
          {isPhone && <TextSticky textData={texts.setTwo} />}
          {isScreen && <TextSticky textData={texts.setThree} />}
